...
async def get_trend(project_id: str) -> Dict[str, Any]:
    """
...
async def get_latest(project_id: str) -> Dict[str, Any]:
...
async def delete_snapshot(project_id: str, snapshot_id: str) -> None:
